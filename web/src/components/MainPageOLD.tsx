...
// import { Task, Data, User, Params, Solution } from '../types';
...
// let defaultElements: Task[] = [{ name: "Kitchen", color: "#836e87", index: 0 },
// { name: "Shower", color: "#9f7a8e", index: 1 },
// { name: "Garbage", color: "#ad7883", index: 2 }]

// let defaultUsers: User[] = [{ name: "Alice",   sid:"0a", index: 0, avatarIdx:0,  isReady:false, preferences: defaultElements },
//                             { name: "Bob",     sid:"0b", index: 1, avatarIdx:1,  isReady:false, preferences: defaultElements },
//                             { name: "Charlie", sid:"0c", index: 2, avatarIdx:12, isReady:false, preferences: defaultElements }]

// export const MainPage = () => {
//     const classes = useStyles();

//     const [users, setUsers] = React.useState<User[]>(defaultUsers)
//     const [elements, setElements] = React.useState<Task[]>(defaultElements)
...
//                 }
//             }
//             let elementsDict: { [name: number]: Task } = {};
